...
public class Bellman_Ford_Negative_Weight_Cycle_Detection {
    static class Graph {
        ...
        // The main function that finds the shortest distances from src to all other vertices using Bellman-Ford
        ...
        void BellmanFord(Graph graph) {
            ...
            // Step 3: check for negative-weight cycles. The above step guarantees the shortest distances if graph
